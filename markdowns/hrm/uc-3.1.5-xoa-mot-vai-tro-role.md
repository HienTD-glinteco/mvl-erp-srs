...
1.  Phân hệ con "Quản lý nhân viên theo Role"
    -----------------------------------------

    1.  ### UC 3.2.1: Xem danh sách + Tìm kiếm Nhân viên theo Role
...
|  | - **Chỉ được chọn Khối khi đã chọn một Chi nhánh cụ thể**, danh sách hiển thị chỉ gồm các Khối thuộc Chi nhánh đó. |
|  | - **Chỉ được chọn Phòng ban khi đã chọn một Khối cụ thể**, danh sách hiển thị chỉ gồm các Phòng ban thuộc Khối đó |
